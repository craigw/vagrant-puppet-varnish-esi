...
<html lang="en">
  ...
  <body>
    <p>I'm the container. I was fetched at <?php echo date('Y-m-d\TH:i:s', mktime()) . substr((string)microtime(), 1, 6) ?>Z (expires = <?php echo $expires; ?>s, generation = <?php echo $time ?>)</p>
